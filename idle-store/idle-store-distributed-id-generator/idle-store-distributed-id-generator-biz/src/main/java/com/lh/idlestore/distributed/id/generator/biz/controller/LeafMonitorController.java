...
import com.lh.idlestore.distributed.id.generator.biz.core.segment.model.SegmentBuffer;
import com.lh.idlestore.distributed.id.generator.biz.model.SegmentBufferView;
...
public class LeafMonitorController {
    ...
    public String getCache(Model model) {
        ...
        SegmentIdGenerator segmentIdGenerator = segmentService.getIdGenerator();
