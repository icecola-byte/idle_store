...
import com.lh.idlestore.distributed.id.generator.biz.core.snowflake.exception.CheckLastTimeException;
...
public class SnowflakeZookeeperHolder {
    ...
    public SnowflakeZookeeperHolder(String ip, String port, String connectionString, String leafName) {
        ...
        this.pathForever = "/snowflake/" + leafName + "/forever";
        this.propPath = System.getProperty("java.io.tmpdir") + File.separator
                + leafName + "/leafconf/{port}/workerID.properties";
    }
